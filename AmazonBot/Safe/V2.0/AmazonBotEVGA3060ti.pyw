...
captcha = False;
keyboard = Controller()
driver.get("https://www.amazon.com/EVGA-GeForce-Gaming-08G-P5-3667-KR-Cooling/dp/B08P2H5LW2/ref=cm_cr_arp_d_product_top?ie=UTF8")
...
while keep_going:
    ...
    if not captcha:
        ...
        if addtocart:
            pyperclip.copy("https://www.amazon.com/EVGA-GeForce-Gaming-08G-P5-3667-KR-Cooling/dp/B08P2H5LW2/ref=cm_cr_arp_d_product_top?ie=UTF8");
            keep_going = False;
...
log.write("RTX3060ti EVGA drop on " + current_time + "\n")
log.close()
