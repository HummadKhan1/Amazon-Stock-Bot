...
captcha = False;
keyboard = Controller()
driver.get("https://www.amazon.com/dp/B08LW46GH2?smid=ATVPDKIKX0DER&tag=espresso004b-20")
...
while keep_going:
    ...
    if not captcha:
        ...
        if addtocart:
            pyperclip.copy("https://www.amazon.com/dp/B08LW46GH2?smid=ATVPDKIKX0DER&tag=espresso004b-20");
            keep_going = False;
...
log.write("RTX3070 EVGA drop on " + current_time + "\n")
log.close()
